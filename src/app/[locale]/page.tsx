              ...
              <StaggerItem key={card.href}>
                ...
                >
                  <div className="mb-6 flex items-start justify-between">
                    ...
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-400 transition-colors group-hover:text-koura-secondary dark:bg-white/10">
